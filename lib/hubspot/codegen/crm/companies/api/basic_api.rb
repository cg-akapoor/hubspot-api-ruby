    ...
    module Companies
      class BasicApi
        ...
        def archive(company_id, opts = {})
          archive_with_http_info(company_id, opts)
          nil
        end
        ...
        # @option opts [String] :id_property The name of a property whose values are unique for this object
        # @return [SimplePublicObject]
        def update(company_id, simple_public_object_input, opts = {})
          data, _status_code, _headers = update_with_http_info(company_id, simple_public_object_input, opts)
          data
        end
        ...
        # @option opts [String] :id_property The name of a property whose values are unique for this object
        # @return [Array<(SimplePublicObject, Integer, Hash)>] SimplePublicObject data, response status code and response headers
        def update_with_http_info(company_id, simple_public_object_input, opts = {})
          if @api_client.config.debugging
